...
if [[ $r_or_t == "r" ]]
then
read -p "Number of jobs you want to run simultaneously: " nb_of_jobs
read -p "Job number you want to start with: " start_nb
echo Run\(s\) $nb_of_jobs job\(s\), starting with job number $start_nb
